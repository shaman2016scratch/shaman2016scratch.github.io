const txt = {
  ...
  "xy": function() { document.getElementById('txt').rows = document.getElementById('xy').input.split('x')[0]; document.getElementById('txt').cols = document.getElementById('xy').input.split('x')[1] }
}
