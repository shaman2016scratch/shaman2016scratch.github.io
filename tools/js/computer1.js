...
screen.innerHTML = `
  ...
  <br><button>Esc</button><button>F1</button><button>F2</button><button>F3</button><button>F4</button><button>F5</button><button>F6</button><button>F7</button><button>F8</button><button>F9</button><button>F10</button><button>PrtSc</button><button>F11</button><button>F12</button><button>Del</button><button>Sys</button>
  ...
  <br><button>~</button><button>Tab</button><button>Q</button><button>W</button><button>E</button><button>R</button><button>T</button><button>Y</button><button>U</button><button>I</button><button>O</button><button>P</button><button>[</button><button>]</button><button>|</button><button>\\</button><button>/</button><button>&</button><button>Open</button>
